/**
 * scripts/setup-office-agents.mjs
 *
 * One-time setup: creates the Anthropic Managed Agents environment and agents.
 * Run: ANTHROPIC_API_KEY=sk-ant-xxx node scripts/setup-office-agents.mjs
 *      (PowerShell: $env:ANTHROPIC_API_KEY="sk-ant-xxx"; node scripts/setup-office-agents.mjs)
 */
