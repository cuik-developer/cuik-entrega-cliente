    ...
    <div className="space-y-8">
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/admin/office/approvals" className="text-sm text-[#0e70db] hover:underline flex items-center gap-1">
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/admin/office/tasks" className="text-sm text-[#0e70db] hover:underline flex items-center gap-1">
            Ver todas <ArrowRight className="w-3 h-3" />
          </Link>
        </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400">
                        ...
                        {task.lastRun && ` \u00B7 Ultima: ${new Date(task.lastRun).toLocaleString("es-MX")}`}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
        ...
        {recentActivity.length === 0 ? (
          ...
          <div className="space-y-2">
            {recentActivity.map((exec) => (
              <div key={exec.id} className="flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-slate-100 transition-colors">
