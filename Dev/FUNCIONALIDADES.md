...
- **Nuevo / Editar premio** (dialogo): foto (PNG/JPG hasta 5 MB; al elegirla se abre un encuadre 16:9 con arrastre y zoom, `_components/photo-adjuster.tsx`, que recorta en canvas a 1200x675 y recien entonces sube el PNG via `POST /api/{tenant}/assets/upload`, guardando su URL relativa `/api/assets/...`; el boton de recorte permite re-encuadrar una foto ya guardada), nombre, descripcion, costo en puntos (entero > 0), categoria, orden y visible.
